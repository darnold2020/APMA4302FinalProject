...
int main(int argc, char *argv[])
{
    ...
    double const B = -6. * 50000000.; //to plot the "low B" case, change this number
    ...
    string file_name = "G-S_row_nonlinear_" + to_string(rank) + "_local.txt";
    ...
    if (rank == 0)
    {
        ...
        string time_name = "G-S_" + to_string(num_procs) + "_procs_scaling.txt";
